...
@Component({
  selector: 'app-editdevicemanager',
  templateUrl: './editdevicemanager.component.html',
  styleUrls: ['./editdevicemanager.component.scss']
})
export class EditdevicemanagerComponent implements OnInit {
